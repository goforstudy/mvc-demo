...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"C:/Users/11827/AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"base/EventBus.js":[function(require,module,exports) {
"use strict";
...
var init = function init(el) {
  new _View.default({
    ...
    render: function render(n) {
      ...
      (0, _jquery.default)(this.html.replace('{{n}}', n)).prependTo((0, _jquery.default)(this.el));
    },
    events: {
      'click #add1': 'add',
      'click #minus1': 'minus',
...
var init = function init(el) {
  new _View.default({
    ...
    render: function render(_ref) {
      ...
      (0, _jquery.default)(this.html(parseInt(index))).prependTo((0, _jquery.default)(this.el));
    },
    // init(el) {
    //     this.el = $(el);
